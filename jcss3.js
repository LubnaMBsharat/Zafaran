function addtocart(x){
    ...
    if(x==19){
        ...
        if(res == 0) {
            ...
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(19)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(19)' ;> Remove </button>";
    ...
    if(x==20) {
        ...
        if (res == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(20)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(20)' ;> Remove </button>";
    ...
    if (x==21) {
        ...
        if (res3 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(21)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(21)' ;> Remove </button>";
    ...
    if(x==22) {
        ...
        if (res4 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(22)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(22)' ;> Remove </button>";
    ...
    if(x==23) {
        ...
        if (res5 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(23)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(23)' ;> Remove </button>";
    ...
    if(x==24) {
        ...
        if (res6 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(24)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(24)' ;> Remove </button>";
