...
function addtocart(x){
    ...
    if(x==1){
        ...
        if(res == 0) {
            ...
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(1)' ;> Remove </button>";
        ...
        if (res == 0) {
            ...
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(2)' ;> Remove </button>";
    ...
    if (x==3) {
        ...
        if (res3 == 0) {
            ...
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(3)' ;> Remove </button>";
    ...
    if(x==4) {
        ...
        if (res4 == 0) {
            ...
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(4)' ;> Remove </button>";
    ...
    if(x==5) {
        ...
        if (res5 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(5)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(5)' ;> Remove </button>";
    ...
    if(x==6) {
        ...
        if (res6 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(6)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(6)' ;> Remove </button>";
