function addtocart(x){
    ...
    if(x==31){
        ...
        if(res == 0) {
            ...
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(1)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(31)' ;> Remove </button>";
    ...
    if(x==32) {
        ...
        if (res == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(2)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(32)' ;> Remove </button>";
    ...
    if (x==33) {
        ...
        if (res3 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(3)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(33)' ;> Remove </button>";
    ...
    if(x==34) {
        ...
        if (res4 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(4)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(34)' ;> Remove </button>";
    ...
    if(x==35) {
        ...
        if (res5 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(35)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(35)' ;> Remove </button>";
    ...
    if(x==36) {
        ...
        if (res6 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(36)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(36)' ;> Remove </button>";
