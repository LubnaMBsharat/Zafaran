function addtocart(x){
    ...
    if(x==7){
        ...
        if(res == 0) {
            ...
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(7)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(7)' ;> Remove </button>";
    ...
    if(x==8) {
        ...
        if (res == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(8)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(8)' ;> Remove </button>";
    ...
    if (x==9) {
        ...
        if (res3 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(9)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(9)' ;> Remove </button>";
    ...
    if(x==10) {
        ...
        if (res4 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(10)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(10)' ;> Remove </button>";
    ...
    if(x==11) {
        ...
        if (res5 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(11)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(11)' ;> Remove </button>";
    ...
    if(x==12) {
        ...
        if (res6 == 0) {
            ...
            cell3.innerHTML = fprice;
            cell3.id = "p11"
            cell4.innerHTML = "<input type='number' id='qun' min='1' max='10' value='1' onblur='refresh(12)' ;>";
            var hi = Number(fprice) * Number(document.getElementById("qun").value);

            //cell4.a= "<button id='qun';>Hii </button>";
            cell5.innerHTML = String(hi);
            cell5.id = "tot";
            cell6.innerHTML = "<button id='del' onclick='removee(12)' ;> Remove </button>";
